            ...
            <main className="container mx-auto px-6 py-16 md:py-24 relative z-10">
              <div className="flex flex-col md:flex-row items-center">
                ...
                >
                  ...
                  >
                    Hi, I'm Harsh, Full-stack engineer specializing in high-performance web apps. National hackathon winner, published author, and freelance developer helping businesses build scalable platforms.
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
